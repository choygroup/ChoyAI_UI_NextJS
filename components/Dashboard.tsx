...
const weatherData = {
  conditions: "Rainy season continues with light rain showers and occasional thundershowers",
  temperature: "Highs around 32-34°C (89-93°F), lows near 25°C (77°F)",
  humidity: "High, often above 85%",
  wind: "Light around 7-11 km/h"
};
          ...
          <div className="flex-1 overflow-y-auto space-y-4">
            <div>
              <h3 className="text-sm font-medium mb-2">
                Daily Briefing: Calendar Reminder, Dhaka Weather Update, and Key Global News Highlights
              </h3>
            ...
            <div>
              <h4 className="text-sm font-medium mb-2">Weather in Dhaka</h4>
              <div className="p-3 border rounded-lg bg-accent/20">
