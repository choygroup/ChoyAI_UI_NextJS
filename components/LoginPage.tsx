          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="w-full h-10 bg-black/40 backdrop-blur-sm border-gray-600/50 text-white placeholder-gray-400 transition-all duration-300 rounded-xl text-sm relative z-10 focus:outline-none focus:ring-0 focus:border-gray-600/50 focus-visible:outline-none focus-visible:ring-0 focus-visible:border-gray-600/50 [&:-webkit-autofill]:bg-black/40 [&:-webkit-autofill]:text-white [&:-webkit-autofill]:shadow-[0_0_0_30px_rgba(0,0,0,0.4)_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:white]"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full h-10 bg-black/40 backdrop-blur-sm border-gray-600/50 text-white placeholder-gray-400 pr-10 transition-all duration-300 rounded-xl text-sm relative z-10 focus:outline-none focus:ring-0 focus:border-gray-600/50 focus-visible:outline-none focus-visible:ring-0 focus-visible:border-gray-600/50 [&:-webkit-autofill]:bg-black/40 [&:-webkit-autofill]:text-white [&:-webkit-autofill]:shadow-[0_0_0_30px_rgba(0,0,0,0.4)_inset] [&:-webkit-autofill]:[-webkit-text-fill-color:white]"
                  required
                />
                <button
                  type="button"
